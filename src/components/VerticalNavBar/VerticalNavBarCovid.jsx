...
const VerticalNavBarCovid = () => {
    return ( 
        <div class="verticalNavBarCovid m-3">
            ...
            <Dropdown as={NavItem}>
            <Dropdown.Toggle as={NavLink} style={{color:"black"}}><a href="#InfoSafeWorkplace">Safe Workplace</a></Dropdown.Toggle>
            <Dropdown.Menu style = {{width: "280px"}}>
                <a href="#InfoWorkplaceManpower"> <h2 className="title-level-2">Workplace and Manpower</h2></a>
            </Dropdown.Menu>
            </Dropdown>

            <Dropdown as={NavItem}>
            <Dropdown.Toggle as={NavLink} style={{color:"black"}}><a href="#InfoMarketingCommunication">Marketing and Communication</a></Dropdown.Toggle>
            <Dropdown.Menu style = {{width: "280px"}}>
                <a href="#InfoMarketing"> <h2 className="title-level-2">Marketing Information</h2></a>
            </Dropdown.Menu>
            </Dropdown>
